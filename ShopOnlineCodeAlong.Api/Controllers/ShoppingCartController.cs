    ...
    public class ShoppingCartController : ControllerBase
    {
        ...
        public async Task<ActionResult<CartItemDto>> GetItem(int id)
        {
            try
            {
                ...
                var products = await this.productRepository.GetItem(cartItem.ProductId);
        ...
        public async Task<ActionResult<CartItemDto>> PostItem([FromBody] CartItemToAddDto itemToAddDto)
        {
            try
            {
                var newCartItem = await this.shoppingCartRepository.AddTiem(itemToAddDto);
        ...
        [HttpPatch("{id:int}")]
        public async Task<ActionResult<CartItemDto>> UpdateQty(int id, CartItemQtyUpdateDto cartItemQtyUpdate)
        {
            try
            {
                var cartItem = await this.shoppingCartRepository.UpdateQty(id, cartItemQtyUpdate);
                if (cartItem == null)
                {
                    return NotFound();
                }
